...
void main(List<String> arguments) async {
  ...
  argParser.addOption("file",
      ...
      defaultsTo: ".",
      help:
          "File to process. Can only be a .CSV file from Pesonet or the directory containing the CSV files.");
  argParser.addOption("freq",
      valueHelp: "frequency",
      defaultsTo: "3",
      help:
          "Check the frequency. Any account with above or equal to this frequency of entries will be highlighted in the script output");
  ...
  print('---------------------------------------------------------------\n\n');
  print(
      'Running the script with the following parameters: File/Dir: \'$fileName\', Checked frequency: $frequency');
  print(
      '\n---------------------------------------------------------------\n\n');
